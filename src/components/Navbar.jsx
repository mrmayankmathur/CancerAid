...
import { menu, search, loader } from "../assets";
...
const Navbar = () => {
  ...
  return (
    <div className="mb-[35px] flex flex-col-reverse justify-between gap-6 md:flex-row">
      <div className="mt-2 flex h-[52px] max-w-[458px] flex-row rounded-[100px] bg-[#1c1c24] py-2 pl-4 pr-2 lg:flex-1">
        <input
          type="text"
      ...
      <div className="hidden flex-row justify-end gap-2 sm:flex">
        {authenticated ? (
          <div className="navigation">
            <a className="button" onClick={handleLoginLogout}>
              {loading ? (
          ...
          <button
            ...
            className="px-4 py-2 mt-2 h-10 text-white bg-blue-500 rounded-lg hover:bg-blue-600 flex items-center justify-center"
          >
            {loading ? (
              <div className="loader-container">
                <img src={loader} alt="Loading..." className="loader" />
