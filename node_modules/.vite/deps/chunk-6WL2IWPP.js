...
var p = z(() => {
  ...
  "use strict";
  b = globalThis, S = (_a = globalThis.setImmediate) != null ? _a : (r) => setTimeout(
    r,
    0
  ), v = (_b = globalThis.clearImmediate) != null ? _b : (r) => clearTimeout(r), g = (_c = globalThis.crypto) != null ? _c : {};
  (_d = g.subtle) != null ? _d : g.subtle = {};
  d = typeof globalThis.Buffer == "function" && typeof globalThis.Buffer.allocUnsafe == "function" ? globalThis.Buffer : $n().Buffer, m = (_e = globalThis.process) != null ? _e : {};
  (_f = m.env) != null ? _f : m.env = {};
  try {
    m.nextTick(() => {
    });
  } catch {
...
var et = T(($h, Di) => {
  ...
  function Mi(r) {
    for (var e = "{", t = 0; t < r.length; t++)
      t > 0 && (e = e + ","), r[t] === null || typeof r[t] > "u" ? e = e + "NULL" : Array.isArray(r[t]) ? e = e + Mi(r[t]) : r[t] instanceof d ? e += "\\\\x" + r[t].toString("hex") : e += Ga(lt(r[t]));
    return e = e + "}", e;
  }
  a(Mi, "arrayString");
...
var gt = z(() => {
  ...
  Fu = a((r) => r.replace(
    ...
    static get poolQueryViaFetch() {
      var _a;
      return (_a = E2.opts.poolQueryViaFetch) != null ? _a : E2.defaults.poolQueryViaFetch;
    }
    ...
    static get fetchEndpoint() {
      var _a;
      return (_a = E2.opts.fetchEndpoint) != null ? _a : E2.defaults.fetchEndpoint;
    }
    ...
    static get fetchFunction() {
      var _a;
      return (_a = E2.opts.fetchFunction) != null ? _a : E2.defaults.fetchFunction;
    }
    ...
    static get webSocketConstructor() {
      var _a;
      return (_a = E2.opts.webSocketConstructor) != null ? _a : E2.defaults.webSocketConstructor;
    }
    ...
    get webSocketConstructor() {
      var _a;
      return (_a = this.opts.webSocketConstructor) != null ? _a : E2.webSocketConstructor;
    }
    ...
    static get wsProxy() {
      var _a;
      return (_a = E2.opts.wsProxy) != null ? _a : E2.defaults.wsProxy;
    }
    ...
    get wsProxy() {
      var _a;
      return (_a = this.opts.wsProxy) != null ? _a : E2.wsProxy;
    }
    set wsProxy(t) {
      this.opts.wsProxy = t;
    }
    static get coalesceWrites() {
      var _a;
      return (_a = E2.opts.coalesceWrites) != null ? _a : E2.defaults.coalesceWrites;
    }
    ...
    get coalesceWrites() {
      var _a;
      return (_a = this.opts.coalesceWrites) != null ? _a : E2.coalesceWrites;
    }
    ...
    static get useSecureWebSocket() {
      var _a;
      return (_a = E2.opts.useSecureWebSocket) != null ? _a : E2.defaults.useSecureWebSocket;
    }
    ...
    get useSecureWebSocket() {
      var _a;
      return (_a = this.opts.useSecureWebSocket) != null ? _a : E2.useSecureWebSocket;
    }
    ...
    static get forceDisablePgSSL() {
      var _a;
      return (_a = E2.opts.forceDisablePgSSL) != null ? _a : E2.defaults.forceDisablePgSSL;
    }
    ...
    get forceDisablePgSSL() {
      var _a;
      return (_a = this.opts.forceDisablePgSSL) != null ? _a : E2.forceDisablePgSSL;
    }
    ...
    static get disableSNI() {
      var _a;
      return (_a = E2.opts.disableSNI) != null ? _a : E2.defaults.disableSNI;
    }
    ...
    get disableSNI() {
      var _a;
      return (_a = this.opts.disableSNI) != null ? _a : E2.disableSNI;
    }
    set disableSNI(t) {
    ...
    static get pipelineConnect() {
      var _a;
      return (_a = E2.opts.pipelineConnect) != null ? _a : E2.defaults.pipelineConnect;
    }
    ...
    get pipelineConnect() {
      var _a;
      return (_a = this.opts.pipelineConnect) != null ? _a : E2.pipelineConnect;
    }
    ...
    static get subtls() {
      var _a;
      return (_a = E2.opts.subtls) != null ? _a : E2.defaults.subtls;
    }
    static set subtls(t) {
      E2.opts.subtls = t;
    }
    get subtls() {
      var _a;
      return (_a = this.opts.subtls) != null ? _a : E2.subtls;
    }
    set subtls(t) {
      this.opts.subtls = t;
    }
    static get pipelineTLS() {
      var _a;
      return (_a = E2.opts.pipelineTLS) != null ? _a : E2.defaults.pipelineTLS;
    }
    ...
    get pipelineTLS() {
      var _a;
      return (_a = this.opts.pipelineTLS) != null ? _a : E2.pipelineTLS;
    }
    set pipelineTLS(t) {
    ...
    static get rootCerts() {
      var _a;
      return (_a = E2.opts.rootCerts) != null ? _a : E2.defaults.rootCerts;
    }
    ...
    get rootCerts() {
      var _a;
      return (_a = this.opts.rootCerts) != null ? _a : E2.rootCerts;
    }
    set rootCerts(t) {
...
var vs = T((vt) => {
  ...
  var D = zr(), ic = bs(), rn = 1, sc = 4, Ss = rn + sc, xs = d.allocUnsafe(0), sn = class sn {
    constructor(e) {
      if (this.buffer = xs, this.bufferLength = 0, this.bufferOffset = 0, this.reader = new ic.BufferReader(), (e == null ? void 0 : e.mode) === "binary")
...
function zs(r, {
  ...
  async function de(A, w, P) {
    ...
    let {
      fetchEndpoint: V,
      fetchFunction: k
    } = Ae, j = typeof V == "function" ? V(C, B) : V, ce = Array.isArray(A) ? { queries: A } : A, ee = n != null ? n : {}, R = e != null ? e : false, G = t != null ? t : false, he = i, ye = s, ve = o;
    ...
    if (se.ok) {
      ...
      if (Array.isArray(A)) {
        ...
        return O.map((K, le) => {
          var _a2, _b2, _c2;
          let _n = (_a2 = w[le]) != null ? _a2 : {}, Js = (_b2 = _n.arrayMode) != null ? _b2 : R, Xs = (_c2 = _n.fullResults) != null ? _c2 : G;
          return Vs(K, { arrayMode: Js, fullResults: Xs, parameterizedQuery: A[le], resultCallback: c });
        });
      } else {
        let O = w != null ? w : {}, K = (_a = O.arrayMode) != null ? _a : R, le = (_b = O.fullResults) != null ? _b : G;
        return Vs(oe, {
          arrayMode: K,
          fullResults: le,
...
var vn = class vn2 extends Ct.Client {
  ...
  connect(t) {
    ...
    let i = ((_a = this.config) == null ? void 0 : _a.host) !== void 0 || ((_b = this.config) == null ? void 0 : _b.connectionString) !== void 0 || m.env.PGHOST !== void 0, s = (_c = m.env.USER) != null ? _c : m.env.USERNAME;
...
var En = class En2 extends Ct.Pool {
  ...
  query(t, n, i) {
    ...
    i = s.callback;
    try {
      let o = new Zs.default(this.options), u = encodeURIComponent, c = encodeURI, h = `postgresql://${u(o.user)}:${u(o.password)}@${u(o.host)}/${c(o.database)}`, l = typeof t == "string" ? t : t.text, y = (_a = n != null ? n : t.values) != null ? _a : [];
...
buffer/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-6WL2IWPP.js.map
