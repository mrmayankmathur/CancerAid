...
function is(value, type) {
  ...
  if (!Object.prototype.hasOwnProperty.call(type, entityKind)) {
    throw new Error(
      `Class "${(_a39 = type.name) != null ? _a39 : "<unknown>"}" doesn't look like a Drizzle entity. If this is incorrect and the class is provided by Drizzle, please report this as a bug.`
    );
  }
...
_a3 = entityKind, _b = TableName, _c = OriginalName, _d = Schema, _e = Columns, _f = ExtraConfigColumns, _g = BaseName, _h = IsAlias, _i = ExtraConfigBuilder;
...
function getTableUniqueName(table) {
  var _a39;
  return `${(_a39 = table[Schema]) != null ? _a39 : "public"}.${table[TableName]}`;
}
...
var ForeignKey = class {
  ...
  getName() {
    ...
    return name2 != null ? name2 : `${chunks.join("_")}_fk`;
  }
};
_a6 = entityKind;
...
var UniqueConstraint = class {
  constructor(table, columns, nullsNotDistinct, name2) {
    ...
    this.table = table;
    this.columns = columns;
    this.name = name2 != null ? name2 : uniqueKeyName(this.table, this.columns.map((column) => column.name));
...
var ExtraConfigColumn = class extends PgColumn {
  constructor() {
    ...
    __publicField(this, "indexConfig", {
      order: (_a12 = this.config.order) != null ? _a12 : "asc",
      nulls: (_b3 = this.config.nulls) != null ? _b3 : "last",
...
_c3 = entityKind;
__publicField(ExtraConfigColumn, _c3, "ExtraConfigColumn");
var _a13;
...
((SQL2) => {
  ...
  _a39 = entityKind;
  __publicField(Aliased, _a39, "SQL.Aliased");
...
_a26 = entityKind, _b4 = ViewBaseConfig;
...
_a32 = entityKind, _b5 = Symbol.toStringTag;
__publicField(QueryPromise, _a32, "QueryPromise");
...
_a33 = entityKind;
__publicField(PrimaryKeyBuilder, _a33, "PgPrimaryKeyBuilder");
var _a34;
var PrimaryKey = class {
  ...
  getName() {
    var _a39;
    return (_a39 = this.name) != null ? _a39 : `${this.table[PgTable.Symbol.Name]}_${this.columns.map((column) => column.name).join("_")}_pk`;
  }
};
_a34 = entityKind;
__publicField(PrimaryKey, _a34, "PgPrimaryKey");
  ...
  for (const [key, value] of Object.entries(schema)) {
    if (is(value, Table)) {
      ...
      tablesConfig[key] = {
        ...
        relations: (_a39 = bufferedRelations == null ? void 0 : bufferedRelations.relations) != null ? _a39 : {},
      ...
      const extraConfig = (_c4 = value[Table.Symbol.ExtraConfigBuilder]) == null ? void 0 : _c4.call(value, value[Table.Symbol.ExtraConfigColumns]);
      if (extraConfig) {
...
function createOne(sourceTable) {
  return function one(table, config) {
    ...
    return new One(
      ...
      table,
      config,
      (_a39 = config == null ? void 0 : config.fields.reduce((res, f) => res && f.notNull, true)) != null ? _a39 : false
    );
  };
}
...
//# sourceMappingURL=chunk-KSGI6T7I.js.map
