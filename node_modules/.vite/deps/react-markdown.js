import {
  require_browser
} from "./chunk-GNDXVLSD.js";
import {
  require_jsx_runtime
} from "./chunk-O2SQI3NG.js";
import "./chunk-U4SILVV6.js";
import {
  __commonJS,
  __export,
  __publicField,
...
function factoryLabel(effects, ok3, nok, type, markerType, stringType) {
  ...
  function atBreak(code2) {
    if (size > constants.linkReferenceSizeMax || code2 === codes.eof || code2 === codes.leftSquareBracket || code2 === codes.rightSquareBracket && !seen || code2 === codes.caret && !size && "_hiddenFootnoteSupport" in self2.parser.constructs) {
      return nok(code2);
    }
